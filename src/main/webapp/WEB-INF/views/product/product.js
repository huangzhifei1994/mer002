$(function() {
	...
	//执行分页逻辑
			...
			function loadProductList(urlnew) {
				...
				keyword = $("#keyword").val();
				search_source = $("#search_msource").val();
				   ...
				   $(".product-edit").click(function(e) {
		            ...
		            $("#dialog-productUpdate-form").dialog({
		                ...
		                open: function(event, ui) {
		                    ...
		                    if (targetProduct) {
								/////////////////////////////////////////////////////////////////
		                    	$("#id2").val(targetProduct.id);
								$("#productImgid2").val(targetProduct.productImgid);
								$("#productMaterialname2").val(targetProduct.productMaterialname);
								$("#productMaterialsource2").val(targetProduct.productMaterialsource);
								$("#productTargetweight2").val(targetProduct.productTargetweight);
								$("#productRealweight2").val(targetProduct.productRealweight);
								$("#productLeftweight2").val(targetProduct.productLeftweight);
								$("#productIrontypeweight2").val(targetProduct.productIrontypeweight);
								$("#productIrontype2").val(targetProduct.productIrontype);
								$("#productStatus2").val(targetProduct.productStatus);
								$("#productRemark2").val(targetProduct.productRemark);
								$("#furnacenumber2").val(targetProduct.furnacenumber);
								/////////////////////////////////////////////////////////////////
		                    }
		                },
		                buttons : {
